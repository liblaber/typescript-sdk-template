  ...
  describe("test showPetById", () => {
    ...
    test("test api call", () => {
      const scope = nock("http://petstore.swagger.io/v1")
        .get("/pets/recusandae")
        .reply(200, {data: {}});
      return sdk.pets.showPetById('recusandae').then((r: any) => expect(r.data).toEqual({}))
    });

    test("test will throw error if required fields missing", () => {
      const scope = nock("http://petstore.swagger.io/v1")
        .get("/pets/reprehenderit")
        .reply(200, {data: {}});
    ...
    test("test will throw error on a non-200 response", () => {
      const scope = nock("http://petstore.swagger.io/v1")
        .get("/pets/magni")
        .reply(404, {data: {}});
      return expect(async () => await sdk.pets.showPetById('magni')).rejects.toThrow();
    });
